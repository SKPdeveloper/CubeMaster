...
class SummaryViewModel @Inject constructor(
                ...
                for (room in rooms) {
                    ...
                    for (surface in surfaces) {
                        ...
                        for (layer in surface.layers) {
                            ...
                            val result = computeLayerResult(layer, areaM2, norm, thickness)
    ...
    private fun computeLayerResult(layer: Layer, areaM2: Double, norm: ConsumptionNorm?, thickness: Double): LayerResult {
